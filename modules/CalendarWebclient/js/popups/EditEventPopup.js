...
const AppointmentUtils = require('modules/%ModuleName%/js/utils/Appointment.js'),
...
CEditEventPopup.prototype.onSaveClick = function () {
  if (this.subject() === '') {
    Popups.showPopup(AlertPopup, [
      TextUtils.i18n('%MODULENAME%/ERROR_SUBJECT_BLANK'),
      _.bind(function () {
        this.subjectFocus(true)
      }, this),
    ])
...
CEditEventPopup.prototype.showGuests = function () {
  if (this.attendees().length > 0) {
    var sConfirm = TextUtils.i18n('%MODULENAME%/CONFIRM_REMOVE_ALL_ATTENDEES'),
...
CEditEventPopup.prototype.addFirstAlarm = function () {
  if (!this.displayedAlarms().length) {
    ...
    var sConfirm = TextUtils.i18n('%MODULENAME%/CONFIRM_REMOVE_ALL_ALARMS'),
      fAction = _.bind(function (bResult) {
        if (bResult) {
...
CEditEventPopup.prototype.setStartDate = function (oMomentDate, bChangeInDatepicker) {
  ...
  this.yearlyDayText(
    TextUtils.i18n('%MODULENAME%/LABEL_REPEAT_YEARLY_DAYMONTH', {
