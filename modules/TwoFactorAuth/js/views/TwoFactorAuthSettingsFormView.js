...
function CTwoFactorAuthSettingsFormView() {
  ...
  this.allowRevokeAll = ko.computed(function () {
    return (
      Settings.AllowTrustedDevices &&
      !!_.find(this.devices(), function (oDevice) {
...
CTwoFactorAuthSettingsFormView.prototype.populateSettings = function () {
  ...
  this.infoShowBackupCodes(
    this.hasBackupCodes()
      ? TextUtils.i18n('%MODULENAME%/INFO_SHOW_BACKUP_CODES', { COUNT: Settings.BackupCodesCount })
      : ''
  )
}
...
CTwoFactorAuthSettingsFormView.prototype.askDisableAuthenticatorApp = function () {
  ...
  Popups.showPopup(ConfirmPopup, [
    sConfirm,
    _.bind(function (bDisableAuthenticatorApp) {
  ...
  Ajax.send(
    ...
    function (oResponse) {
      if (oResponse && oResponse.Result) {
        this.securityKeys(
          _.filter(this.securityKeys(), function (oSecurityKey) {
...
CTwoFactorAuthSettingsFormView.prototype.askRevokeTrustFromAllDevices = function () {
  var sConfirm = TextUtils.i18n('%MODULENAME%/CONFIRM_REVOKE_ALL'),
    sHeading = TextUtils.i18n('%MODULENAME%/CONFIRM_HEADING_REVOKE_ALL')
  Popups.showPopup(ConfirmPopup, [
    sConfirm,
    _.bind(function (bRevokeAll) {
      if (bRevokeAll) {
...
CTwoFactorAuthSettingsFormView.prototype.askLogoutFromDevice = function (sDeviceId, sDeviceName) {
  var sConfirm = TextUtils.i18n('%MODULENAME%/CONFIRM_LOGOUT_DEVICE'),
    sHeading = TextUtils.i18n('%MODULENAME%/CONFIRM_HEADING_LOGOUT_DEVICE', {
      NAME: sDeviceName,
    })
  Popups.showPopup(ConfirmPopup, [
    sConfirm,
    _.bind(function (bLogout) {
      if (bLogout) {
