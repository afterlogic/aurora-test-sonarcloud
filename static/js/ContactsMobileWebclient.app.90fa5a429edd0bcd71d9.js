				...
				getScreens: function () {
					...
					if (ContactsSettings && Types.isNonEmptyString(ContactsSettings.HashModuleName))
					{
						oScreens[ContactsSettings.HashModuleName] = function () {
							return __webpack_require__(/*! modules/ContactsMobileWebclient/js/views/ContactsView.js */ "1BQy");
						};
					}
					return oScreens;
				},
...
var
	...
	f7 = __webpack_require__(/*! framework7 */ "Fiyv"), // needs to be initialized
	
	Types = __webpack_require__(/*! modules/CoreWebclient/js/utils/Types.js */ "KC/L"),
	
	App = __webpack_require__(/*! modules/CoreWebclient/js/App.js */ "9kOp"),
	
	CContactsDesktopView = __webpack_require__(/*! modules/ContactsWebclient/js/views/CContactsView.js */ "iiou"),
...
function CContactsView()
{
	...
	App.broadcastEvent('ContactsMobileWebclient::ConstructView::after', {'Name': this.ViewConstructorName, 'View': this});
