"use strict";
(self["webpackChunkafterlogic_aurora_platform"] = self["webpackChunkafterlogic_aurora_platform"] || []).push([[65],{
...
var
	...
	Ajax = __webpack_require__(/*! modules/FilesWebclient/js/Ajax.js */ "pokp"),
...
var
	...
	Ajax = __webpack_require__(/*! modules/FilesWebclient/js/Ajax.js */ "pokp"),
	CFolderModel = __webpack_require__(/*! modules/FilesWebclient/js/models/CFolderModel.js */ "p/ia"),
...
const CreateFolderPopup = __webpack_require__(/*! modules/FilesWebclient/js/popups/CreateFolderPopup.js */ "dgrw"),
  CreateLinkPopup = __webpack_require__(/*! modules/FilesWebclient/js/popups/CreateLinkPopup.js */ "U9LU"),
  RenamePopup = __webpack_require__(/*! modules/FilesWebclient/js/popups/RenamePopup.js */ "HaM1"),
  SharePopup = __webpack_require__(/*! modules/FilesWebclient/js/popups/SharePopup.js */ "FJ45"),
  LinksUtils = __webpack_require__(/*! modules/FilesWebclient/js/utils/Links.js */ "LGWn"),
  Ajax = __webpack_require__(/*! modules/FilesWebclient/js/Ajax.js */ "pokp"),
  Settings = __webpack_require__(/*! modules/FilesWebclient/js/Settings.js */ "U1j7"),
  CFileModel = __webpack_require__(/*! modules/FilesWebclient/js/models/CFileModel.js */ "CsgX"),
  CFolderModel = __webpack_require__(/*! modules/FilesWebclient/js/models/CFolderModel.js */ "p/ia")
...
function CFilesView(bPopup = false, allowSelect = true) {
  ...
  this.rootPath = ko.observable(
    this.bPublic ? Settings.PublicFolderName : TextUtils.i18n('FILESWEBCLIENT/LABEL_PERSONAL_STORAGE')
  )
  this.storageType = ko.observable(Enums.FileStorageType.Personal)
    ...
    _.each(
      ...
      function (iValue, sName) {
        if (Settings.Sorting.DisplayOptions.indexOf(sName) >= 0) {
          this.aSortList.push({
            sText: TextUtils.i18n('FILESWEBCLIENT/SORT_OPTION_' + sName.toUpperCase()),
            sSortBy: iValue,
          })
        }
      }.bind(this)
    ...
    .computed(function () {
      ...
      sOUtput =
        this.files().length === 0 && this.folders().length === 0
          ? ''
          : TextUtils.i18n('FILESWEBCLIENT/CURRENT_FOLDER_STATS', {
      ...
      sOUtput +=
        this.selectedFiles().length === 0
          ? ''
          : ' | ' +
            TextUtils.i18n('FILESWEBCLIENT/CURRENT_FOLDER_STATS_SELECTED_FILES', {
      ...
      sOUtput +=
        this.selectedFolders().length === 0
          ? ''
          : ' | ' +
            TextUtils.i18n('FILESWEBCLIENT/CURRENT_FOLDER_STATS_SELECTED_FOLDERS', {
  ...
  App.broadcastEvent('FilesWebclient::RegisterFilesController', (controller, place) => {
...
CFilesView.prototype.isFileCanBeUploaded = function (oFileData) {
  if (Settings.EnableUploadSizeLimit && oFileData.Size / (1024 * 1024) > Settings.UploadSizeLimitMb) {
    Popups.showPopup(AlertPopup, [
      TextUtils.i18n('FILESWEBCLIENT/ERROR_SIZE_LIMIT', {
...
CFilesView.prototype.moveItems = function (sMethod, oFolder, aChecked) {
  ...
  if (
    ...
    if (oToStorage.type === Enums.FileStorageType.Personal && oFromStorage.type !== Enums.FileStorageType.Personal) {
      ...
      if (!bAllowMove) {
        Popups.showPopup(AlertPopup, [
          TextUtils.i18n('FILESWEBCLIENT/ERROR_CANT_MOVE_FILES_QUOTA_PLURAL', {}, '', aChecked.length),
        ])
        return false
      }
    }
...
CFilesView.prototype.onMoveResponse = function (oResponse, oRequest) {
  if (!oResponse.Result) {
    if (oResponse.ErrorCode === Enums.Errors.CanNotUploadFileQuota) {
      Popups.showPopup(AlertPopup, [
        TextUtils.i18n('FILESWEBCLIENT/ERROR_CANT_MOVE_FILES_QUOTA_PLURAL', {}, '', oRequest.Parameters.Files.length),
      ])
    } else {
      Api.showErrorByCode(
        oResponse,
        TextUtils.i18n('FILESWEBCLIENT/ERROR_FILES_MOVE_PLURAL', {}, '', oRequest.Parameters.Files.length)
      )
    }
...
CFilesView.prototype.dragAndDropHelper = function (oDraggedItem, ctrlOrCmdUsed) {
  ...
  if (!oCounts.file) {
    sText = TextUtils.i18n(
      'FILESWEBCLIENT/LABEL_DRAG_FOLDERS_PLURAL',
    ...
    sText = TextUtils.i18n(
      'FILESWEBCLIENT/LABEL_DRAG_FILES_PLURAL',
    ...
    sText = TextUtils.i18n(
      'FILESWEBCLIENT/LABEL_DRAG_ITEMS_PLURAL',
...
CFilesView.prototype.renameItem = function (sExtension, sNamePart) {
  ...
  if (!Utils.validateFileOrFolderName(sName)) {
    return oItem instanceof CFolderModel
      ? TextUtils.i18n('FILESWEBCLIENT/ERROR_INVALID_FOLDER_NAME')
      : TextUtils.i18n('FILESWEBCLIENT/ERROR_INVALID_FILE_NAME')
  } else {
    Ajax.send(
      'Rename',
      {
...
CFilesView.prototype.executeDelete = function () {
  ...
  if (!this.bPublic && itemsToDeleteCount > 0) {
    ...
    if (askAboutSharedItems) {
      ...
      confirmText = TextUtils.i18n(
        'FILESWEBCLIENT/CONFIRM_DELETE_FOLDERS_PLURAL',
        { COUNT: itemsToDeleteCount },
        null,
        itemsToDeleteCount
      )
      ...
      confirmText = TextUtils.i18n(
        'FILESWEBCLIENT/CONFIRM_DELETE_FILES_PLURAL',
        { COUNT: itemsToDeleteCount },
        null,
        itemsToDeleteCount
      )
